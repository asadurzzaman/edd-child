...
/**
 * Template Name: Affiliate Area Template
 */
?>
<?php
get_header();
            ...
            <div class="col-sm-12">
                <div class="myaccount-wrapper">
                    <div class="tabs">
                        ...
                        <a href="<?php echo site_url() ?>/affiliate-area/" class="tab_item active" data-target="affiliate-area">Affiliate</a>
                    ...
                    <div class="tap-body-wrapper">
                        <div id="affiliate" class="tab_body">
