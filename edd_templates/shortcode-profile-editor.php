...
if (is_user_logged_in()) :
	...
	<div class="user_box">
		<div class="user_name">
			<p><span><?php echo esc_attr($first_name); ?></span>, <?php echo esc_html('Welcome to your profile') ?></p>
		</div>
		<div class="user_details">

			<ul class="fedd_payment_header">
				<h4>Account Details</h4>
				<li class="user_avatar">
					<?php echo get_avatar($user_id, '96'); ?>
				</li>
				<li>
					<span class="head_label">Name</span>
					<span class="head_value"><?php echo esc_html($current_user->first_name); ?></span>
				</li>
				<li>
					<span class="head_label">Email</span>
					<span class="head_value"><?php echo esc_attr($current_user->user_email); ?></span>
				</li>
				<li>
					<span class="head_label">Date of Birth</span>
					<span class="head_value">--</span>
				</li>
			</ul>
		</div>
		<div class="billing_details">
			<ul class="fedd_payment_header">
				...
				<li>
					<span class="head_label">Company Name</span>
					<span class="head_value"><?php echo esc_html($current_user->first_name); ?></span>
				</li>
				<!-- <li>
					<span class="head_label">VAT/TAX Number</span>
					<span class="head_value"><?php //echo esc_html($current_user->first_name); 
												?></span>
				</li> -->
				<li>
					<span class="head_label">Address</span>
					<span class="head_value">
						<?php
						if (!empty($address['line1'])) {
							echo "Village+Post:" . $address['line1'] . ", ";
						}
						if (!empty($address['line2'])) {
							echo "PS:" . $address['line2'] . ", ";
						}
						if (!empty($address['city'] and $address['city'])) {
							echo "City:" . $address['city'] . ", " . $address['zip'] . ", " . $address['city'];
						}
						?>
					</span>
				</li>
		...
		<div class="edit_button">
			<button id="modal-button">Edit Profile Info</button>
		</div>
	</div>
	<!-- Modal -->
	<div id="modal">
